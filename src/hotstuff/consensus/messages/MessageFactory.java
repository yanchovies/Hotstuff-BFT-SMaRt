...
public class MessageFactory {
    ...
    public static final int NEWVIEW = 44800;
    ...
    public NewViewMessage createNewLeader(int newLeaderId,int cid, int epoch){
        return new NewViewMessage(from,NEWVIEW,newLeaderId,cid,epoch);
    }
