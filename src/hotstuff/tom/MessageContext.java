...
public class MessageContext implements Serializable {
    ...
    private final Set<SigShareMessage> proof;
    private final BigInteger n;   //threshold signature public key
    private final BigInteger e;   //threshold signature public key
    ...
    public MessageContext(int sender, int viewID, TOMMessageType type,
                          ...
                          Set<SigShareMessage> proof, BigInteger n, BigInteger e, TOMMessage firstInBatch, boolean noOp) {
    ...
    /**
     * Returns the threshold signature pk for the consensus.
     *
     * @return The threshold signature for the consensus
     */
