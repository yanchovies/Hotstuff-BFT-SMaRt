...
import hotstuff.tom.leaderchange.LCMessage;
            ...
            if (tomLayer.controller.getStaticConf().getUseMACs() == 0 || sm.authenticated) {
                ...
                if (sm instanceof LCMessage) {
                    ...
                    if (lcMsg.getReg() != -1 && lcMsg.getSender() != -1)
                        logger.debug("Received leader change message of type "+type+" for regency "+lcMsg.getReg()+" from replica "+lcMsg.getSender()+"" );
